...
// for project 6
import project6Img1 from "../assets/Project6/agency-1.jpg";
import project6Img2 from "../assets/Project6/agency-2.jpg";
import project6Img3 from "../assets/Project6/agency-3.jpg";
import project6Img4 from "../assets/Project6/agency-4.jpg";
import project6Img5 from "../assets/Project6/agency-5.jpg";
import project6Img6 from "../assets/Project6/agency-6.jpg";

// for project 7
import project7Img1 from "../assets/Project7/quick-chat-1.jpg";
import project7Img2 from "../assets/Project7/quick-chat-2.jpg";
import project7Img3 from "../assets/Project7/quick-chat-3.jpg";
...
// resumeLink
const resume =
  "https://drive.google.com/file/d/13z01i7GPGtspQPqqFQeEDeB2GS4x_coD/view?usp=sharing";
...
const servicesList = [
  ...
  },
  {
    ...
    description:
      "Utilize React.js along with backend technologies (like Node.js, Express.js, or others) to develop custom web applications. Use Firebase for real-time data syncing and backend services, such as authentication, databases, and hosting.",
  },
  {
...
const portfolio = [
  {
    ...
    description:
      "quick-chat is a full-stack real-time chat application built with React, Node.js, Socket.IO & MongoDB, enabling instant messaging with user authentication and responsive UI.",
    link: "https://quick-chat.vercel.app/",
  },
  {
    images: [
      project6Img1,
    ...
    title: "Agency Ai",
    description:
      "agency.ai is a modern and responsive landing page built with React, Vite, and Framer Motion, featuring smooth animations and a clean UI tailored for digital agencies and startups.",
    link: "https://agency-ai-navy.vercel.app/",
  },
  {
    images: [
      project1Img1,
  ...
  },
  {
    ...
    description:
      "I've developed an adaptive blog platform using React,js for smooth data handling with Firebase, prioritizing security to safeguard user information. The emphasis is on providing an accurate, secure, and user-centric blogging experience.",
  ...
  },
  {
    ...
    title: "My Site",
    description:
      "This website showcases a My Site homepage. The platform emphasizes the site offerings, which encompass innovative design, performance enhancement, and complete customization. The site also includes feedback from delighted clients and a prompt to download the My Site application.",
  ...
  },
  {
    ...
    title: "Quiz App",
    description:
      "I have developed a quiz app using React.js that generates random questions and tracks your score in real-time. The app not only provides immediate feedback on your performance but also determines whether you've passed or failed, offering an engaging and interactive quiz experience.",
  ...
  },
  {
    ...
    description:
      "I have crafted a user-friendly and responsive enrolment form that mirrors the functionality of the Saylani form. This project was a fantastic opportunity to enhance my skills in HTML, CSS, and JavaScript, as well as integrate Firebase Firestore for seamless data storage.",
